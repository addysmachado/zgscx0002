...
function(Controller) {
	...
	return Controller.extend("sap.hana.cloud.samples.factsap_app.view.Bandeja", {
		...
		handleItemPress: function (evt) {
			...
			var dat = evt.getSource().getBindingContext().getPath().substr(11); // deja solo el elemento sin la ruta
			
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.navTo("DetalleBandeja",  {
				factura: dat 
			}, false);	  				
