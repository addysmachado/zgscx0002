...
public class ConsumirODATA {
	...
	@Path("/log")
    @Produces(MediaType.APPLICATION_JSON)
	public Response getJobLog(@QueryParam("jobname")  String jobName,
			                  @QueryParam("jobcount") String jobCount) {
        ...
        try{			
            ...
            String destinationURL = baseURL + "/sap/opu/odata/SAP/ZGSCX0002_SRV/LogJobSet?$filter=Jobname%20eq%20'"+jobName+"'%20and%20Jobcount%20eq%20'"+jobCount+"'&$format=json";//     JobSet?$filter=Jobname%20eq%20'"+jobName+"'%20and%20Username%20eq%20'"+userName+"'&$format=json";
            
            System.out.println(" 1. Ingresa  ");
            System.out.println(" 2. destinationURL  "+destinationURL);
            // Execute HTTP request
            httpGet = new HttpGet(destinationURL);
